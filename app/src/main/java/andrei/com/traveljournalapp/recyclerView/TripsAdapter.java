package andrei.com.traveljournalapp.recyclerView;
...
public class TripsAdapter extends FirestoreAdapter<TripsViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final andrei.com.traveljournalapp.recyclerView.TripsViewHolder tripsViewHolder, final int i) {
